...
function Customers() {
    return (
        <div className='mt-8 mb-8 products p-3 md:px-60 flex flex-col items-center gap-x-7 gap-y-7'>
            ...
            <div class="logos">
                <div class="logo-scroll">
                    ...
                    <img src="https://www.ombrulla.com/damac.webp" alt="Damac" class="p-5 md:ms-20 h-[8rem] md:h-[12rem] logo" />
